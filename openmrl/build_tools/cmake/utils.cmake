...
MACRO(MRL_ADD_EXECUTABLE PARAM_EXE_NAME PARAM_FILE_LIST)
	...
	TARGET_LINK_LIBRARIES(${EXE_NAME} mrl)

ENDMACRO(MRL_ADD_EXECUTABLE)


# Macro to add a MR library in the build system
MACRO(MRL_ADD_LIBRARY PARAM_FILE_LIST)
	...
	IF(WIN32)
		ADD_LIBRARY(mr${LIBRARY_NAME} STATIC ${FILE_LIST})
	ELSE(WIN32)	
		ADD_LIBRARY(mr${LIBRARY_NAME} SHARED ${FILE_LIST})
	ENDIF(WIN32)

	TARGET_LINK_LIBRARIES(mr${LIBRARY_NAME} mrl)
	INCLUDE_DIRECTORIES("${OpenMRL_DIR}/src")
	
ENDMACRO(MRL_ADD_LIBRARY)
