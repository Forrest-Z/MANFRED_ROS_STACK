...
public:
  ...
  LocED(const unsigned int& d, const unsigned int& st, const float& cr, const float& f,
        ...
        const std::string& nomb_fich_a, const std::string& nomb_fich_b, const float& alcance_laser_m, const double& angulo_max,
  ...
  // esta ocupada.
  static const float umbral_ocupacion_ = 0.750;
