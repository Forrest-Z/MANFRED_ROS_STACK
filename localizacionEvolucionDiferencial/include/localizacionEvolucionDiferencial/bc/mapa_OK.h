...
public:
  ...
  MapaLoc(const MapaLoc& mapa) :
      filas_(mapa.filas_), columnas_(mapa.columnas_), nombre_fich_(mapa.nombre_fich_), img_mapa_orig_(
          mapa.img_mapa_orig_), img_mapa_modif_(mapa.img_mapa_modif_), matriz_probabilidad_ocupacion_(mapa.matriz_probabilidad_ocupacion_)
  {

  }

  MapaLoc() :
      filas_(0), columnas_(0), nombre_fich_("")
  {
  }
